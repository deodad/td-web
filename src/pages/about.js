...
export default () =>
  <Layout>
    ...
    <p>
      I grew up in Austin, Texas, which is where I live today with my wife and
      two chocolate labs. My parents moved down here from Massachusetts when I
      was two.
    </p>

    <h3 className="mt-6">Boyhood</h3>

    <p>
      I was lucky enough to grow up with loving parents and in a city that was
      growing up around me. My dad took to me to SxSW when I was 6 and I
      remember my high school years by who played at Austin City Limits.
    </p>

    <p>
      I mostly wasn't interested in school itself, something I consider a missed opportunity
      and a pattern I'd repeat in college.
    </p>
    ...
    <p>
      At the start of 2018 I left Personal Wine to co-found a company with
      three individuals I had a lot of respect for. Our intention was to build
      a lean, boot-strapped SaaS company.
    </p>
    ...
    <p>
      ...
      plans. The idea was that each company has a similar set of tasks like this,
      and often times the employee experience is fragmented across many systems.
